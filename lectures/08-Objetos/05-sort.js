var arrayDeNombres = ["Lisa", "Marge", "Homero", "Bart", "Maggie"];
// console.log(arrayDeNombres.sort());
//* MODIFICA ARRAY ORIGINAL !!!!!
// console.log(arrayDeNombres);

var arrayDeNumeros = [5, 100, 80, 2000];
console.log(arrayDeNumeros.sort(function(a, b){
  return b - a;
}));
...
console.log(perfiles.sort(function(perfilA, perfilB){
  return perfilB.antiguedad - perfilA.antiguedad;
}));
